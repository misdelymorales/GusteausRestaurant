export default {
    ...
    liMenuUltimo: "p-2 pr-4 pl-4 hover:bg-vino-light hover:text-white rounded-md cursor-pointer",
    estiloMesaActiva: "cursor-pointer rounded-xl border-2 border-vino bg-vino text-white w-16 h-16 flex items-center justify-center font-semibold text-lg",
    numeroMesa: "pt-4 p-4 bg-white absolute top-28 left-20 rounded-xl shadow-md text-vino",
