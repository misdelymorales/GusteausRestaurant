export default{
    ...
    contenedorItem: {
        base: "md:flex bg-white  rounded-xl p-8 md:p-0 ml-4 border-none ",
        itemImagen:"w-24 h-24 md:w-40 md:h-auto  md:rounded-l-lg mx-auto",
        textoItem: " pt-2 pl-2 text-center md:text-left space-y-2 pr-2.5  ",
